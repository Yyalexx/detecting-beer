...
В этом проекте в целях автоматизации анализа отчетов мерчендайзеров производится подсчет количества позиций в первом ряду витрины одной из единиц анализируемого ассортимента на каждой фотографии.  
