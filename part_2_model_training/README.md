...
первоначально для *baseline* была выбрана модель YOLOv5s, но потом она была заменена на модель YOLOv5m, которая обеспечила достаточно хорошее качество детекции объектов.  
