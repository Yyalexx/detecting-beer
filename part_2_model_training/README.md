...
<img align="" width="400" height="" src=../img/metrics/9.png>

# Визуализация предикта  
Для визуализации результатов детекции объектов был проведен демонстрационный предикт на тестовой выборке в ноутбуке **demo_predict.ipynb**, представленный в этой папке. На обработанные фото нанесены результаты предикта в виде рамок.
